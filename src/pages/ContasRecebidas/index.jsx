...
const ContasRecebidas = () => {
    ...
    return (
        <div className='container-relatorio-recebidas'>
            <div className='titulo-contas-recebidas'>
                <h1>Relatório de Contas Recebidas</h1>
            </div>

            <div className='container-filtro-recebidas'>
            ...
            {loading ? (
                ...
                <div className="caixa-relatorio-recebidas">
                    <div className="cabecalho-relatorio-recebidas">
                        <p>
                    ...
                    <table className="tabela-relatorio-recebidas">
                        <thead>
                            <tr>
                    ...
                    <div className="container-totalizador-recebidas">
