...
const ContasPagas = () => {
    ...
    return (
        <div className="flex flex-col gap-6">
            <h1 className="text-2xl font-semibold text-text">Relatório de Contas Pagas</h1>
            ...
            <div>
                ...
                {loading ? (
                    ...
                    <div className="flex flex-col items-center gap-3 rounded-lg border border-border bg-surface p-10 text-center">
                        ...
                        <h3 className="text-lg font-semibold text-text">Nenhum pagamento realizado ainda</h3>
                        <p className="text-sm text-muted2">Os pagamentos confirmados aparecerão aqui assim que forem marcados como pagos.</p>
                    </div>
                    ...
                    <div className="flex flex-col gap-3">
                                                        ...
                                                        <tr key={item.id} className="border-t border-border">
                                                            ...
                                                            <td className="px-4 py-2">
                                                                <Badge variant="success">
                                                                    <FaCheckCircle className="mr-1 inline" /> Pago
                                                                </Badge>
                                                            </td>
                                                        </tr>
                                                    ))}
                        ...
                        <div className="flex items-center justify-between rounded-lg border border-danger/30 bg-danger/5 px-4 py-3">
                            <span className="font-medium text-text">Total Pago</span>
