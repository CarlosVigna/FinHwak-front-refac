...
const ContasReceber = () => {
    ...
    const handleExportPDF = async () => {
        ...
        try {
            await generateReportPDF({
                ...
                accountName,
                fileName: `relatorio_contas_receber_${accountId}.pdf`,
    ...
    return (
        <div className="flex flex-col gap-6">
            <h1 className="text-2xl font-semibold text-text">Relatório de Contas a Receber</h1>
            ...
            <div>
                ...
                {loading ? (
                    ...
                    <div className="flex flex-col items-center gap-3 rounded-lg border border-border bg-surface p-10 text-center">
                        ...
                        <h3 className="text-lg font-semibold text-text">Nenhum recebimento pendente</h3>
                        <p className="text-sm text-muted2">Registre lançamentos do tipo recebimento para acompanhá-los aqui.</p>
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="flex items-center justify-between rounded-lg border border-success/30 bg-success/5 px-4 py-3">
                            <span className="font-medium text-text">Total a Receber</span>
